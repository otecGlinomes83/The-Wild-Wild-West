...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    public event Action SwitchWeaponRequested;
    ...
    private void OnEnable()
    {
        ...
        _playerInput.Player.SwitchWeapon.performed += OnSwitchWeaponPerformed;
    ...
    private void OnSwitchWeaponPerformed(UnityEngine.InputSystem.InputAction.CallbackContext context) =>
        SwitchWeaponRequested?.Invoke();
